...
We also provide 32-channel hyperspectral SAI image and its tranfer matrix in <ins>~/test/simulation_32channels/</ins> for comparisons with other analytical methods demonstrated in the paper.
## Run the demo
