...
def parse_args():
    ...
    parser.add_argument('--testset_dir', type=str, default='dataset/testset/mouse_spleen/4c/')

    parser.add_argument("--patchsize", type=int, default=140, help="inference patches size")
    parser.add_argument("--stride", type=int, default=140, help="stride size two inference patches")
    parser.add_argument("--netChannel", type=int, default=64, help="the feature layers of network")

    parser.add_argument('--model_path', type=str, default='pretrain_model_demo/mouse_spleen/4c/epoch_150.pth.tar')
    parser.add_argument('--save_path', type=str, default='output/mouse_spleen/4c/')
