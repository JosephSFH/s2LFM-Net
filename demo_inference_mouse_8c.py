...
def parse_args():
    ...
    parser.add_argument('--testset_dir', type=str, default='dataset/testset/mouse_spleen/8c/')
    ...
    parser.add_argument('--model_path', type=str, default='pretrain_model_demo/mouse_spleen/8c/epoch_150.pth.tar')
    parser.add_argument('--save_path', type=str, default='output/mouse_spleen/8c/')
